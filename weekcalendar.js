...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
      ...
      refresh : function() {
         this._clearCalendar();
         this._loadCalEvents(this.element.data("startDate")); //перезагрузить с текущей неделей
      },
      ...
      /*
       * Переход к любой неделе в зависимости от даты
       */
      ...
      /*
       * Удаление несохранённых событий
       */
      ...
      /*
       * обновление события, если оно уже существует
       */
      ...
      /*
       * Возвращает массив времени начала и окончания события. 
       */
      ...
      /*
       * конфигурация событий календаря
      ...
      _renderCalendar : function() {
         ...
         //добавление частей календаря в контейнер 
      ...
      /*
       * загрузка событий в зависимости ото дня
       */
      ...
      /*
       * Поиск групп перекрывающих событий
       */
      _groupOverlappingEventElements : function($weekDay) {
         ...
         $.each(sortedEvents, function() {
            ...
            //создание группы в случае их отсутствия
      ...
      /*
       *находит день недели в текущем календаре, в который входит calEvent
       */
      ...
      /*
       * размещение события в зависимости от даты
       */
      ...
      /*
       * Определение времени событи в зависимости от расоложения в календаре
       */
      ...
      _adjustForEventCollisions : function($weekDay, $calEvent, newCalEvent, oldCalEvent, maintainEventDuration) {
         ...
         $weekDay.find(".wc-cal-event").not($calEvent).each(function() {
            ...
            //перенос в существующее событие прии перекрытии времени окончания
            ...
            //перенос в существующее событие прии перекрытии времени начала
            if (newCalEvent.end.getTime() > currentCalEvent.start.getTime()
                  && newCalEvent.start.getTime() <= currentCalEvent.start.getTime()) {

               adjustedEnd = currentCalEvent.start;
            }
            //перенос события в событие такой же или большей продолжительнойсти 
         ...
         //сбросить если длительность события нулевая
      ...
      /*
       * возможность перетаскивания события
       */
      ...
      /*
       * возможность изменения размера calEvent
       */
      ...
      /*
       * Обновление деталей calEvent в календаре
       */
      ...
      /*
       * возвращает дату первой милисекунды недели 
       */
      ...
      /*
       * возвращает время первой милисекунды последнего дня недели 
       */
      ...
      /*
       * дата последней милисекунды недели 
       */
   ...
   $.extend($.ui.weekCalendar, {
      ...
      defaults: {
         ...
         shortMonths : ['Янв', 'Фев', 'Мар', 'Aпр', 'Май', 'Июн', 'Июл', 'Авг', 'Сен', 'Окт', 'Ноя', 'Дек'],
